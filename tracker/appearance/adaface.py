...
def build_model(model_name="ir_50"):
    if model_name == "resnet101_ir":
        return IR_101(input_size=(112, 112))
    elif model_name == "resnet50_ir":
        return IR_50(input_size=(112, 112))
    elif model_name == "se_resenet50_ir":
        return IR_SE_50(input_size=(112, 112))
    elif model_name == "resnet34_ir":
        return IR_34(input_size=(112, 112))
    elif model_name == "resnet18_ir":
...
class BottleneckIR(nn.Module):
    ...
    def __init__(self, in_channel, depth, stride):
        ...
        self.res_layer = nn.Sequential(
            ...
            nn.Conv2d(
                reduction_channel, reduction_channel, (3, 3), (1, 1), 1, bias=False
            ),
            nn.BatchNorm2d(reduction_channel),
            nn.PReLU(reduction_channel),
