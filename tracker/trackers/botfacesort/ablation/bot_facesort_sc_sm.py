...
class STrack(BaseTrack):
    ...
    def re_activate(self, new_track, frame_id, new_id=False, shot_changed=False):
        ...
        if new_track.curr_feat is not None:
            self.update_features(new_track.curr_feat, self.id)
        self.tracklet_len = 0
        self.state = TrackState.Tracked
        self.is_activated = True
        self.frame_id = frame_id
...
class BoTFaceSORT(object):
    ...
    def update(self, face_dets, img, shot_changed, landmarks=None):
        ...
        # print(f"len(self.lost_stracks): {len(self.lost_stracks)}")
        ...
        for itracked, idet in matches:
            ...
            if track.state == TrackState.Tracked:
                track.update(det, self.frame_id, shot_changed)
        ...
        # print(f"lost_stracks: {lost_stracks}")
        # print("2. Activated starcks: ", activated_starcks)
