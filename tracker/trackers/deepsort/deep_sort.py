...
from tracker.trackers.deepsort.sort.detection import Detection
from tracker.trackers.deepsort.sort.tracker import Tracker
...
class DeepSort(object):
    def __init__(
        ...
        self.tracker = Tracker(
            metric, max_iou_dist=max_iou_dist, max_age=max_age, n_init=n_init
        )
